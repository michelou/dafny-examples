...
set _LAST_MODIFIED_OLD=michelou/)/November 2025
set _LAST_MODIFIED_NEW=michelou/)/December 2025

set _LAST_DOWNLOAD_OLD=(\*November 2025\*)
set _LAST_DOWNLOAD_NEW=(*December 2025*)

@rem to be transformed into -not -path "./<dirname>/*"
set _EXCLUDE_TOPDIRS=bin docs oneapi-examples
set _EXCLUDE_SUBDIRS=_LOCAL TheModernCppChallenge_Code
